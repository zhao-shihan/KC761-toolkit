...
from kc761tool import __version__
from kc761tool.errors import Kc761toolError, UsageError
from kc761tool.runtime import configure_logging, strict_enabled
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"[kc761tool.{args.command}] error: {exc}", file=sys.stderr)
        return 2
    try:
