...
functions call them and raise :class:`kc761tool.errors.CertificateError` with the
formula ID. Product-level certificates (F-SIM-2 on the stored `fSumw2`) also
run in :mod:`kc761tool.schema.io` under strict mode; these functions guard the
