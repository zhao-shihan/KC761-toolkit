...
D-120..D-128). Geometry values live in :mod:`kc761tool.sim.geometry`, the source
registry in :mod:`kc761tool.sim.sources` and the material data in
:mod:`kc761tool.sim.materials`; this module only holds run orchestration constants.
...
from kc761tool.schema.products import OBJ_PRIMARY_TO_DEPOSITION
