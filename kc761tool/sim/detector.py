...
length is derived from :mod:`kc761tool.sim.geometry` and the source dataclasses, so
...
from kc761tool.sim.geometry import DEFAULT_GEOMETRY, DetectorGeometry
...
def build_detector(
    source, materials, *, geometry: DetectorGeometry = DEFAULT_GEOMETRY, check_overlaps: bool = True
):  # noqa: ANN001, ANN201
    ...
    class _Detector(_base):
        ...
        def _place_volume(self, lv, name, position, mother_lv, rotate_to_y):  # noqa: ANN001
            if rotate_to_y:
                ...
                _placement(None, position, lv, name, mother_lv, False, 0, self.check_overlaps)
        ...
        def _construct_container(self, container, position, world_lv):  # noqa: ANN001
            ...
            self._place_volume(tube_lv, "SourceTube", position, world_lv, container.axis == "y")
