...
from kc761tool.schema.axes import UNIT_CHANNEL, UNIT_KEV
...
# single source in ``kc761tool.core.binning`` (D-121); the fit-time response uses
# that fixed uniform axis (D-101). They stay as module attributes for the
# public ``kc761tool.calib`` surface, but are not a second implementation.
