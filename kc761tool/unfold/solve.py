...
The solver is :func:`kc761tool.core.solver.solve_nonnegative`; the uncertainty
bands come from :mod:`kc761tool.core.uncertainty` with the **same** half-Hessian
...
from kc761tool.core.model import InternalCalibration, resolution_sigma_kev
...
from kc761tool.core.uncertainty import (
    UncertaintyBands,
    combine_bands,
...
from kc761tool.unfold.selection import fit_sigma
