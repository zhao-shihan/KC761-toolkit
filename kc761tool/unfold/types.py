...
``kc761tool/unfold`` implementation. Numerics and product contracts stay in
``kc761tool.core`` and ``kc761tool.schema``; this module only groups the pieces that a
...
@dataclass(frozen=True)
class ComposeResult:
    """Result of :func:`kc761tool.unfold.compose.run_compose` (F-RESP-2)."""
...
@dataclass(frozen=True)
class UnfoldResult:
    """Result of :func:`kc761tool.unfold.unfold.run_unfold` (F-UNF-4/F-UNF-5).
