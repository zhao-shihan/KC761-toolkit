...
raise is a :class:`kc761tool.errors.Kc761toolError` subclass with an actionable message.
"""
...
from kc761tool.core.binning import source_mode_deposition_edges_kev
from kc761tool.core.covariance import CovarianceEstimate, verify_covariance_psd
...
from kc761tool.core.uncertainty import UncertaintyBands, verify_band_decomposition
from kc761tool.errors import (
    CertificateError,
    Kc761toolError,
    ProvenanceError,
    SchemaError,
...
from kc761tool.schema.axes import UNIT_KEV, Axis, check_same_edges
...
def validate_output_path(path: str | Path, *, force: bool = False) -> None:
    ...
    :class:`kc761tool.errors.UsageError` (CLI exit code 2, "pass --force or fix the
