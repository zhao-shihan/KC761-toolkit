...
``kc761tool.schema.io``. Every name, unit and meta field literal used by the
IO layer is defined here or in :mod:`kc761tool.schema.axes` so there is a single
...
from kc761tool.errors import SchemaError
