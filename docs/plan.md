...
| D-189 | The unfold figure keeps a **linear** energy x-axis; only the y-axis of the middle panel is logarithmic. This narrows the "log axes" convention of D-153 to the calibration figure and is recorded because D-153 named log axes as a shared figure convention. |
