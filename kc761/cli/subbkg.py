...
def _load_spectrum(path: Path, *, strict: bool):
    ...
    from kc761.schema.products import SpectrumProduct
...
def _run(args: argparse.Namespace, *, strict: bool) -> int:
    ...
    from kc761.schema.products import SCHEMA_VERSION, Histogram1D, SpectrumProduct
    ...
    product = SpectrumProduct(
        ...
        provenance=build_provenance(
            producer="kc761-subbkg",
            command="kc761 subbkg",
